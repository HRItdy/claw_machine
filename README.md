...
- Now there is a asynchronization between the camera view and the interactive window. When click on 'No', use the camera view to fresh the interactive window once.
